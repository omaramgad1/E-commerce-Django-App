...
class CustomUserManager(BaseUserManager):
    def _create_user(self, email, password, phone, first_name, last_name, **extra_fields):
        if not email:
    ...
    def create_user(self, email, password, first_name, last_name, phone, **extra_fields):
        ...
        return self._create_user(email, password, first_name, last_name, phone, password, **extra_fields)
...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    profileImgUrl = models.ImageField(
        upload_to='profileImages/{username}_{created}', validators=[validate_image])
